<#
 SYNTAX
 Copy required JNI library and headers into the current directory.

 DESCRIPTION
 Utility used during JNI build to copy required DLLs and headers into the
 `binding/jgraphiti` working directory so the build and runtime can find them.
