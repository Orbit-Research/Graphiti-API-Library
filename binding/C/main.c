...
int main() {
    ...
    graphiti_sleep(graphiti,5);

    /**
     * @function graphiti_showMessageOnBraille
     * @brief Displays a Braille message on the device
     * @param handle Graphiti device handle
     * @param message Braille message data
     * @param msgLength Length of the message data
     * @param count Maximum number of Braille cells
     */
    unsigned char brailleMessage[40] = {
    ...
    printf("Calling show_Message_On_The_Braille_Functionality...\n");
    graphiti_showMessageOnBraille(graphiti, brailleMessage, sizeof(brailleMessage), 40);
    graphiti_sleep(graphiti,5);
    printf("show_Message_On_The_Braille_Functionality completed\n");
