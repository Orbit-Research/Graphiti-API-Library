...
Tests covered:
  ...
  - show_Message_On_The_Braille_Functionality
...
#  10. show_Message_On_The_Braille_Functionality
print("Running: show_Message_On_The_Braille_Functionality")
input("    Press Enter to continue: ")
try:
    g.show_messageOnBraille(bytes([0x01, 0x03, 0x09, 0x19, 0x11, 0x0B, 0x1B, 0x13, 0x0A, 0x1A,
                                    0x05, 0x07, 0x0D, 0x1D, 0x15, 0x0F, 0x1F, 0x17, 0x0E, 0x1E,
                                    0x25, 0x27, 0x3A, 0x2D, 0x3D, 0x35, 0x01, 0x03, 0x09, 0x19,
                                    0x11, 0x0B, 0x1B, 0x13, 0x0A, 0x1A, 0x00, 0x00, 0x00, 0x00]), 40)
    time.sleep(2)
    log("show_Message_On_The_Braille_Functionality", True,
        "Check device: message 'abcdefghijklmnopqrstuvwxyz1234567890' visible on Braille display")
except Exception as e:
    log("show_Message_On_The_Braille_Functionality", False, str(e))

#  11 set_Cursor_Functionality
