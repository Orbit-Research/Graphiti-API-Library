...
- documents
    ...
    - Graphiti API Specification v1.2.md  
        - This document describes the communication protocol between a host device (a PC, for instance) and the Graphiti® Tactile Graphics and Braille Display,with detailed descriptions of each command. 

    - Graphiti Plus - API mode APP NOTE v0.1.md
...
- lib
    ...
    - library.ps1
        ...
        - If you would like to specify your Generator or compiler add them as @param like in this example:
