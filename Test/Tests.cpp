...
void Tests::registerTests(){
    testRegistry = {
        ...
        {"show_Message_On_The_Braille_Functionality", {[this]() { return show_Message_On_The_Braille_Functionality(); }, false, false }},
        //Set Cursor Test
...
//Show Message on Braille Test
/**
 * @function: Tests::show_Message_On_The_Braille_Functionality
 * @brief: Shows a test message on the device and waits briefly.
 * @return: bool - true on success
 */
bool Tests::show_Message_On_The_Braille_Functionality() {
    // message in Braille: "abcdefghijklmnopqrstuvwxyz1234567890"
    graphiti->showMessageOnBraille({0x01, 0x03, 0x09, 0x19, 0x11, 0x0B, 0x1B, 0x13, 0x0A, 0x1A,
                                    0x05, 0x07, 0x0D, 0x1D, 0x15, 0x0F, 0x1F, 0x17, 0x0E, 0x1E,
                                    0x25, 0x27, 0x3A, 0x2D, 0x3D, 0x35, 0x02, 0x06, 0x12, 0x32,
                                    0x22, 0x16, 0x36, 0x26, 0x14, 0x34, 0x00, 0x00, 0x00, 0x00}, 40);
    graphiti->sleep(2);
