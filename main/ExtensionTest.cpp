/**
  ******************************************************************************
  * @file    ExtensionTest.cpp
  * @company Orbit Research
  * @version v1.0
  * @date    08-12-25
  * @brief   Sample program demonstrating GraphitiExtension usage.
  *
  * @details
  * A simple example that shows how to use GraphitiExtension for key and draw
  * demos and basic device interactions. Deprecated in favor of test harness.
  *
  ******************************************************************************
  * @attention
 ...
 * @brief Handles key events for one-pixel and row/column demo.
 * @param keyEvent Set of key event strings.
 ...
 * @brief Prints draw event pin information for debugging/demo.
 * @param drawEvent Draw event structure.
 * @param context User context pointer.
 * @return void
 */
...
/**
 * @Function sleepAndOutput
 * @brief Sleep briefly then print next ASCII output event if available.
 * @return void
 */
void sleepAndOutput(){
    graphiti->sleep(2);
...
/**
 * @Function ReadOuptputDemo
 * @brief Run with key responses off, print device info.
 * @return void
 */
 ...
 * @brief Calls updateDisplay with height 2 and blinkRate 0 for all pins.
 * @return std::vector<uint8_t> The screen vector it was set to.
 */
...
/**
 * @Function UpdateRow
 * @brief Calls updateSingleRow with height 2 and blinkRate 0.
 * @param row Row index to update.
 * @return std::vector<uint8_t> The row vector it was set to.
 */
 ...
 * @brief Calls updateSingleColumn with height 2 and blinkRate 0.
 * @param column Column index to update.
 * @return std::vector<uint8_t> The column vector it was set to.
 */
...
/**
 * @Function UpdatePixelsDemo
 * @brief Demo sequence that exercises various pixel update APIs.
 * @return void
 */
 ...
 * @brief Dispatcher helper that calls named display helper functions and returns expected output.
 * @param funcitonName Name of the display function.
 * @param arg1 Argument 1.
 * @param arg2 Argument 2.
 * @param arg3 Argument 3.
 * @param arg4 Argument 4.
 * @return std::vector<uint8_t> Expected output vector.
 */
 ...
 * @brief Dispatcher helper that calls named status functions.
 * @param funcitonName Name of the status function.
 * @param arg1 Argument 1.
 * @param arg2 Argument 2.
 * @return void
 */
 ...
 * @brief Prints a vector of bytes in hex format.
 ...
 * @brief Run a display helper, wait, call status query and print pass/fail.
 * @param displayFunctionName Name of display function.
 * @param displayDelay Delay after display function.
...
/**
 * @Function GetStatusDemo
 * @brief Get Status commands 4.3.6 - 4.3.9. Requires UpdatePixelsDemo to work.
 * @return void
 */
void GetStatusDemo(){
...
/**
 * @Function KeyDemo
 * @brief Run a key-loop demo using OnePixel_KeyFunction.
 * @return void
 */
void KeyDemo() {
...
/**
 * @Function DrawDemo
 * @brief Run draw-loop demo using PrintDraw_DrawFunction.
 * @return void
 */
void DrawDemo() {
    #ifdef DEBUG
...
/**
 * @Function ImageDemo
 * @brief Demo for sending an image to the device.
 * @return void
 */
void ImageDemo() {
 ...
 * @brief Creates a sample image file for testing.
 * @return void
 */
void createImage(){
...
/**
 * @Function main
 * @brief Main entry point for the demo program.
